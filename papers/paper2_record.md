...
| **51** | **Structure vs scale** (the tagline) | equivariant flat over orbit (ratio 1.1–1.2); 84×-scaled MLP buys in-wedge interp (30–166×, beats equiv in-dist) but climbs 170–2700× out-of-wedge, 10–155× above equiv floor (3 seeds) | — | `3be4fd0` |
...
| **UR-JEPA** | isotropy vs manifold → ours is **group-prescribed** (ρ-pinned 3e-4 vs 1.04); Step 56 concedes in-dist, wins OOD 320× | paper2 §5; lejepa (Step 54/56); core §relwork |
